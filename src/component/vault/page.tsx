...
//   return (
//     <MainLayout isDarkTheme={false} toggleTheme={function (): void {
...
// function getAssociatedTokenAddress(USDC_MINT: anchor.web3.PublicKey, publicKey: anchor.web3.PublicKey, arg2: boolean, TOKEN_PROGRAM_ID: anchor.web3.PublicKey, ASSOCIATED_TOKEN_PROGRAM_ID: anchor.web3.PublicKey) {
//   throw new Error('Function not implemented.');
// }
